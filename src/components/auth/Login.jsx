    ...
    <div className="bg-[#1c1c1c] flex items-center justify-center w-full h-screen text-white">
      <div className="parentWrapper flex flex-col items-start justify-center">
        ...
        <form
          ...
          className="flex flex-col items-center justify-center gap-2 h-80 w-[30vw] mt-5 px-5 py-5 border-emerald-400 border-[1px] rounded-xl"
        >
          <input
          ...
          <button
            type="submit"
            className="w-[80%] bg-emerald-300 text-black font-semibold px-3 py-2 rounded-full bg-transparent"
          >
            Log in
          </button>
        </form>
